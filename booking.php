...
<body>
    ...
    <?php
include_once 'include/webheader.php';
?>
    ...
    <!-- Car Booking Start -->
    <form action="include/uinsert.inc.php" method="POST">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                <input type="text" class="form-control p-4" placeholder="Mobile Number" required="required" name="num">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        <div class="row">
                            <div class="col-6 form-group">
                            <input type="text" class="form-control p-4" placeholder="Pick up Location" required="required" name="plocation">

                            </div>
                            <div class="col-6 form-group">
                            <input type="text" class="form-control p-4" placeholder="Drop location" required="required" name="dlocation">
                        ...
                        <div class="row">
                            <div class="col-6 form-group">
                                ...
                                <input type="text" class="form-control p-4" placeholder="Pickup time" required="required" name="ptime">

                                </div>
                            </div>
                            <div class="col-6 form-group">
                                <div class="time" id="time2" data-target-input="nearest">
                                <input type="text" class="form-control p-4" placeholder="Pick up date" required="required" name="pdate">
